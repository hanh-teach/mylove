...
export const ZoomControls: React.FC<ZoomControlsProps> = ({
  ...
  return (
    <div 
      ref={containerRef}
      className="relative flex items-center gap-1.5 bg-white/90 backdrop-blur-md px-3 py-2 rounded-2xl shadow-xl border border-rose-100 select-none animate-in fade-in slide-in-from-bottom-2 duration-200"
    >
      {/* Zoom Out Button */}
      <button
