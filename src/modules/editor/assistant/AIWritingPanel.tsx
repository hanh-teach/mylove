...
import { Sparkles, Wand2, Scissors, Expand, CheckCheck, Languages, X, Heart, Code, BrainCircuit } from 'lucide-react';
  ...
  return (
    <div className="w-full bg-white rounded-2xl shadow-xl border border-rose-100 p-5 flex flex-col gap-4 relative overflow-y-auto max-h-[88vh]">
      ...
      {aiAssistEnabled ? (
        ...
        <div className="p-8 bg-slate-50 rounded-3xl border-2 border-dashed border-slate-200 text-center space-y-3 animate-in fade-in duration-500">
          <div className="w-12 h-12 bg-slate-100 rounded-full flex items-center justify-center mx-auto text-slate-400">
            <BrainCircuit size={24} />
          </div>
          <div className="space-y-1">
            <p className="text-sm font-black text-slate-600">Hỗ trợ AI đang tắt</p>
            <p className="text-[11px] text-slate-500 max-w-[200px] mx-auto leading-relaxed">
              Tính năng này đã bị vô hiệu hóa theo cài đặt của bạn. Vui lòng bật lại trong phần <b>Cài đặt AI</b>.
            </p>
          </div>
        </div>
      )}
