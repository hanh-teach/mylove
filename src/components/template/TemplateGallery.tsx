...
export const TemplateGallery: React.FC<TemplateGalleryProps> = ({
  ...
  const renderPreviewCanvas = (tmpl: TemplateConfig, device: DeviceType) => {
    ...
    const fontStyleClass = 
      theme.fontStyle === 'playfair' || theme.fontStyle === 'merriweather' || theme.fontStyle === 'lora' ? 'font-serif' :
      theme.fontStyle === 'lobster' || theme.fontStyle === 'dancing' ? 'italic' :
      theme.fontStyle === 'pacifico' ? 'font-sans italic' :
      theme.fontStyle === 'caveat' ? 'font-mono' : 'font-sans';
