...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <div className={`flex flex-col h-full bg-white dark:bg-slate-900 overflow-hidden transition-colors ${isDrawer ? 'w-full' : 'w-16 border-r border-slate-200 dark:border-slate-800'}`}>
