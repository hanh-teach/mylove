...
const TEXT_PRESETS = [
  ...
  { id: 'bold_title', label: 'Tiêu đề nổi bật', font: 'lobster', text: 'Chúc Mừng Hạnh Phúc', size: '2xl' },
  { id: 'editorial', label: 'Trang nhã & Cổ điển', font: 'merriweather', text: 'Kỷ niệm ngày bên nhau', size: 'xl' },
