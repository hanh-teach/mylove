...
import { Sparkles, RotateCcw, Play, Pause, Volume2, Edit3, Heart, Image as ImageIcon, BookOpen, Music, Check, Share2, Layers, Award, ShieldCheck, Tag, Globe } from 'lucide-react';
...
export const Card3DViewer: React.FC<Card3DViewerProps> = ({
  ...
  return (
    <div className="w-full h-full min-h-[680px] bg-slate-950 text-white rounded-3xl p-4 md:p-8 flex flex-col justify-between relative overflow-hidden select-none border border-slate-800 shadow-2xl">
      ...
      <div className="relative z-20 flex flex-wrap items-center justify-between gap-3 bg-slate-900/80 backdrop-blur-xl p-3 md:p-4 rounded-2xl border border-slate-800 shadow-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400 hidden sm:block">
              Lật mở thiệp chân thực & Xoay 360° để ngắm nhìn chi tiết
            </p>
          </div>
        </div>
                ...
                <div className="space-y-2 pt-3 border-t border-slate-200 dark:border-slate-800">
                  ...
                  <div className="flex items-center justify-between pt-2">
                    <button
                      ...
                      className="text-xs text-slate-500 hover:text-slate-900 dark:hover:text-white font-bold flex items-center gap-1"
                    >
                      ← Đóng bìa thiệp
                    </button>
                    <button
            ...
            >
              <div className="border border-white/20 rounded-2xl p-6 h-full flex flex-col justify-between items-center">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-full bg-white/20 hover:bg-white/30 text-xs font-bold transition-all"
                >
                  Lật về trang trong
                </button>
              </div>
      ...
      {/* Bottom Bar: Theme Color Selector & Info */}
      <div className="relative z-20 flex flex-col sm:flex-row items-center justify-between gap-3 bg-slate-900/80 backdrop-blur-xl p-3 rounded-2xl border border-slate-800">
        <div className="flex items-center gap-2">
          <span className="text-xs font-bold text-slate-400">Tông màu Bìa Thiệp:</span>
          {[
        ...
        <div className="text-[11px] text-slate-400 flex items-center gap-2">
          <span>💡 Mẹo: Giữ chuột & kéo để xoay thiệp 3D trong không gian</span>
        </div>
      </div>
