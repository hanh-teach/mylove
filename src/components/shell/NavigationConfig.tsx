...
import { 
  ...
  Folder, LayoutDashboard, Download, Printer, Plus, Star, Database, Zap, ShieldCheck
} from 'lucide-react';
...
export const NavigationConfig: NavigationSection[] = [
  {
    ...
    items: [
      ...
      { id: 'projects', label: 'Dự án', icon: <Folder size={16} />, tabType: 'project-dashboard' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'settings', label: 'Cài đặt', icon: <Settings size={16} />, tabType: 'settings' },
