...
export type AppTabType = 'home' | 'card' | 'editor' | 'assets' | 'memory' | 'timeline' | 'aistudio' | 'design-system' | 'knowledge' | 'project-dashboard' | 'graph' | 'collaboration' | 'sync' | 'settings' | 'plugins';
