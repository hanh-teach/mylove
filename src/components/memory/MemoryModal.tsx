...
import { X, Sparkles, Image, MapPin, Calendar, Heart, Plus, Tag as TagIcon, FileText, Video, Music, Clock, FolderHeart, Upload } from 'lucide-react';
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    className="px-2.5 py-1 bg-rose-50 hover:bg-rose-100 text-rose-700 rounded-lg text-[11px] font-bold flex items-center gap-1 transition-all"
                  >
                    <Image size={12} />
                  ...
                  <button
                    ...
                    className="px-2.5 py-1 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 rounded-lg text-[11px] font-bold flex items-center gap-1 transition-all"
                  >
                    <Upload size={12} />
              ...
              <div className="flex gap-2 items-center mb-2">
                <input
                  ...
                  placeholder="https://images.unsplash.com/... hoặc chọn từ Thư viện"
                  className="flex-1 p-2.5 rounded-xl border border-slate-300 text-xs focus:ring-2 focus:ring-rose-500 focus:outline-none"
                />
                {coverImage && (
                  <div className="w-10 h-10 rounded-xl overflow-hidden border border-slate-200 shrink-0 bg-slate-100 shadow-xs">
