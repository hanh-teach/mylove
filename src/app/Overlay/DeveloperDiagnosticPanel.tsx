  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-2 right-24 w-8 h-8 bg-slate-900/80 text-white rounded-lg shadow-md flex items-center justify-center z-30 hover:bg-slate-800 transition-all active:scale-95 text-xs opacity-70 hover:opacity-100"
